...
//   //         Constants.SwerveConstants.RIGHT_FRONT_TURN_ID,
//   //         Constants.SwerveConstants
//   //             .PRACTICE_RIGHT_FRONT_DRIVE_INVERTED, // used to be true, Might have to change
// back
//   //         // Om:
//   //         // 2/14/24
//   //         Constants.SwerveConstants.PRACTICE_RIGHT_FRONT_TURN_INVERTED,
...
//   //         Constants.SwerveConstants.RIGHT_BACK_TURN_ID,
//   //         Constants.SwerveConstants
//   //             .PRACTICE_RIGHT_BACK_DRIVE_INVERTED, // used to be true, Might have to change
// back
//   //         // Om:
//   //         // 2/14/24
//   //         Constants.SwerveConstants.PRACTICE_RIGHT_BACK_TURN_INVERTED,
...
//             .publish();
//     // m_posePublish =
// NetworkTableInstance.getDefault().getTable("Goldfish").getStructTopic("Robot
//     // Pose", Pose2d.struct).publish();
//     SmartDashboard.putData(
//         "Swerve Drive",
//         new Sendable() {
...
//     // rates 2 is yaw (XYZ in order )
//     /*SmartDashboard.putString("Angular Speed", new DecimalFormat("#.00").format((yaw/ 180)) +
// "pi rad/s");
//     // Logger.recordOutput("Robot Angle", getHeading());
//     // Logger.recordOutput("Robot Pitch", getPitch());
//     // Logger.recordOutput("Robot Roll", getRoll());
//     // Logger.recordOutput("Pose", getPose().toString());
//     // Logger.recordOutput("Angular Speed", new DecimalFormat("#.00").format((yaw / 180)) + "pi
// rad/s" );
...
//     SmartDashboard.putNumber("Right Back Module Velocity", rightBack.getDriveMotorVelocity());
//     SmartDashboard.putNumber("Left Front Module abs angle", leftFront.getAbsoluteEncoderAngle());
//     SmartDashboard.putNumber("Right Front Module abs angle",
// rightFront.getAbsoluteEncoderAngle());
//     SmartDashboard.putNumber("Left Back Module abs angle", leftBack.getAbsoluteEncoderAngle());
//     SmartDashboard.putNumber("Right Back Module abs angle",
// rightBack.getAbsoluteEncoderAngle());*/
...
//         builder.addDoubleProperty("Front Left Angle", () -> leftFront.getTurnMotorPosition(),
// null);
//         builder.addDoubleProperty("Front Left Velocity", () -> leftFront.getDriveMotorVelocity(),
// null);

//         builder.addDoubleProperty("Front Right Angle", () -> rightFront.getTurnMotorPosition(),
// null);
//         builder.addDoubleProperty("Front Right Velocity", () ->
// rightFront.getDriveMotorVelocity(), null);

//         builder.addDoubleProperty("Back Left Angle", () -> leftBack.getTurnMotorPosition(),
// null);
//         builder.addDoubleProperty("Back Left Velocity", () -> leftBack.getDriveMotorVelocity(),
// null);

//         builder.addDoubleProperty("Back Right Angle", () -> rightBack.getTurnMotorPosition(),
// null);
//         builder.addDoubleProperty("Back Right Velocity", () -> rightBack.getDriveMotorVelocity(),
// null);
...
//       frontSpeed =
//           Math.abs(frontSpeed) > SwerveConstants.DriverConstants.xDeadband ? frontSpeed : 0;
//       sideSpeed = Math.abs(sideSpeed) > SwerveConstants.DriverConstants.yDeadband ? sideSpeed :
// 0;
//       turnSpeed =
//           Math.abs(turnSpeed) > SwerveConstants.DriverConstants.turnDeadband ? turnSpeed : 0;
//     }
